...
<a href="/AgriConnectN/logout_form.php">Logout</a>
    ...
    <a href="/AgriConnectN/Agutayan_report.php" class="btn btn-primary">Create Survey Report</a>
</div>

    <div class="dashboard-box">
        <h2>BARANGAY AGUTAYAN</h2><br>
...
<table class="table">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM farmer_acc2 WHERE barangay= 'Agutayan' ORDER BY barangay ASC";
...
xhttp.open("GET", "Agutayan_fetch_crop_list.php?farmName=" + farmName, true);
xhttp.send();
}
</script>
<script>
