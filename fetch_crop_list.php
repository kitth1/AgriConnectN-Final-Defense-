...
<body>
<a class='btn btn-primary' href='/AgriConnectN/add_crop.php?farmName=<?php echo urlencode($farmName); ?>'>Add Crop</a>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a class='btn btn-primary' href='/AgriConnectN/update_crop.php?ID=" . $row["id"] . "'>Update</a></td>";
                    echo "<td><a class='btn btn-primary' href='/AgriConnectN/delete_crop.php?ID=" . $row["id"] . "'>Delete</a></td>";
                    echo "</tr>";
                }
            } else {
