...
<body>
        <div class="sidebar">
        <h1>Agri Map</h1>
    <a class='btn' href='/AgriConnectN/admin_login.php'> LOGIN </a>
    </header>
...
<div id="map"></div>
    ...
    markers.forEach(marker => {
        ...
        window.onload = initMap;
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqzh32K6FXy0xKEpbWwVp2Eqw6OLgR5cY&callback=initMap" async defer></script> <!-- Replace with your API key -->
        </body>
        </html>