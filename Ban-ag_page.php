...
<a href="/AgriConnectN/logout_form.php">Logout</a>
    ...
    <a href="/AgriConnectN/Ban-ag_report.php" class="btn btn-primary">Create Survey Report</a>
</div>

    <div class="dashboard-box">
        <h2>BARANGAY BAN-AG</h2><br>
...
<table class="table">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM farmer_acc2 WHERE barangay= 'Ban-ag' ORDER BY f_lastname ASC";
...
xhttp.open("GET", "Ban-ag_fetch_crop_list.php?farmName=" + farmName, true);
xhttp.send();
}
</script>
<script>
